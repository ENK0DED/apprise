...
impl Clickatell {
  pub fn from_url(url: &ParsedUrl) -> Option<Self> {
    ...
    if let Some(ref s) = source {
      ...
      if digits.is_empty() || digits.len() < 10 || digits.len() > 14 {
        return None;
      }
    }
  ...
  pub fn static_details() -> ServiceDetails {
    ServiceDetails {
      ...
      service_url: Some("https://clickatell.com"),
      setup_url: None,
      protocols: vec!["clickatell"],
      description: "Send SMS via Clickatell.",
...
mod tests {
  ...
  fn test_from_url_struct_fields() {
    let parsed = crate::utils::parse::ParsedUrl::parse("clickatell://1111111111@aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/2222222222").unwrap();
  ...
  fn test_from_url_query_params() {
    let parsed =
      crate::utils::parse::ParsedUrl::parse("clickatell://_?apikey=aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa&from=1111111111&to=2222222222,3333333333").unwrap();
    let obj = Clickatell::from_url(&parsed).unwrap();
    assert_eq!(obj.apikey, "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
  ...
  fn test_from_url_no_source() {
    let parsed = crate::utils::parse::ParsedUrl::parse("clickatell://aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/1111111111").unwrap();
    let obj = Clickatell::from_url(&parsed).unwrap();
    assert_eq!(obj.apikey, "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
