...
impl D7Networks {
  pub fn from_url(url: &ParsedUrl) -> Option<Self> {
    ...
    let token = if let Some(t) = url.get("token") {
      ...
      if let Some(ref p) = url.password { format!("{}:{}", u, p) } else { u.clone() }
  ...
  pub fn static_details() -> ServiceDetails {
    ServiceDetails {
      ...
      service_url: Some("https://d7networks.com"),
      setup_url: None,
      protocols: vec!["d7sms"],
      description: "Send SMS via D7 Networks.",
...
mod tests {
  ...
  fn test_from_url_struct_fields_simple() {
    let parsed = crate::utils::parse::ParsedUrl::parse("d7sms://mytoken@15551231234/15551231236").unwrap();
  ...
  fn test_from_url_colon_in_token() {
    let parsed = crate::utils::parse::ParsedUrl::parse("d7sms://token:colon2@33333333333333?batch=yes").unwrap();
    let obj = D7Networks::from_url(&parsed).unwrap();
  ...
  fn test_from_url_token_starting_with_colon() {
    let parsed = crate::utils::parse::ParsedUrl::parse("d7sms://:token3@33333333333333?batch=yes").unwrap();
    let obj = D7Networks::from_url(&parsed).unwrap();
  ...
  fn test_from_url_token_query_param() {
    let parsed = crate::utils::parse::ParsedUrl::parse("d7sms://33333333333333?token=token6").unwrap();
    let obj = D7Networks::from_url(&parsed).unwrap();
  ...
  fn test_from_url_to_query_param() {
    let parsed = crate::utils::parse::ParsedUrl::parse("d7sms://token@33333333333333?to=66666666666666").unwrap();
    let obj = D7Networks::from_url(&parsed).unwrap();
    assert_eq!(obj.targets.len(), 2);
    assert!(obj.targets.contains(&"33333333333333".to_string()));
  ...
  fn test_multiple_targets() {
    let parsed = crate::utils::parse::ParsedUrl::parse("d7sms://token8@33333333333333/44444444444444/?unicode=yes").unwrap();
    let obj = D7Networks::from_url(&parsed).unwrap();
    assert_eq!(obj.targets.len(), 2);
  }
