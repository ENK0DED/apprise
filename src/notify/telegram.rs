    ...
    async fn send(&self, ctx: &NotifyContext) -> Result<bool, NotifyError> {
        ...
        for target in &self.targets {
            ...
            for attach in &ctx.attachments {
                ...
                let resp = client.post(&attach_url)
                    .multipart(form)
                    .send().await;
                if let Ok(r) = resp {
...
mod tests {
    ...
    async fn test_http_500_returns_false() {
        ...
        Mock::given(method("POST"))
            ...
            .respond_with(ResponseTemplate::new(500).set_body_json(
                serde_json::json!({"description": "Internal Server Error"}),
            ))
            .expect(1)
            .mount(&server)
            .await;
    ...
    async fn test_image_attachment_uses_send_photo() {
        ...
        Mock::given(method("POST"))
            .and(path(format!("/bot{}/sendPhoto", TEST_BOT_TOKEN)))
            .respond_with(ResponseTemplate::new(200))
            .expect(1)
            .mount(&server)
            .await;
    ...
    async fn test_video_attachment_uses_send_video() {
        ...
        Mock::given(method("POST"))
            ...
            .await;
        Mock::given(method("POST"))
            .and(path(format!("/bot{}/sendVideo", TEST_BOT_TOKEN)))
            .respond_with(ResponseTemplate::new(200))
            .expect(1)
            .mount(&server)
            .await;
    ...
    async fn test_audio_attachment_uses_send_audio() {
        ...
        Mock::given(method("POST"))
            ...
            .await;
        Mock::given(method("POST"))
            .and(path(format!("/bot{}/sendAudio", TEST_BOT_TOKEN)))
            .respond_with(ResponseTemplate::new(200))
            .expect(1)
            .mount(&server)
            .await;
    ...
    async fn test_voice_attachment_uses_send_voice() {
        ...
        Mock::given(method("POST"))
            ...
            .await;
        Mock::given(method("POST"))
            .and(path(format!("/bot{}/sendVoice", TEST_BOT_TOKEN)))
            .respond_with(ResponseTemplate::new(200))
            .expect(1)
            .mount(&server)
            .await;
