...
impl Form {
    ...
    pub fn static_details() -> ServiceDetails {
        ServiceDetails { service_name: "Form", service_url: None, setup_url: None, protocols: vec!["form", "forms"], description: "Send a form-encoded notification to any HTTP endpoint.", attachment_support: false }
    }
}
