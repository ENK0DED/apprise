...
fn build_registry() -> HashMap<String, FactoryFn> {
    ...
    reg!(burstsms::BurstSms::from_url, "burst");
    ...
    reg!(fluxer::Fluxer::from_url, "fluxer");
    reg!(fortysixelks::FortySixElks::from_url, "46elks");
    ...
    reg!(jellyfin::Jellyfin::from_url, "jellyfin", "jellyfinc");
    ...
    reg!(lametric::LaMetric::from_url, "lametric");
    ...
    reg!(notificationapi::NotificationApi::from_url, "notificationapi");
    reg!(notifico::Notifico::from_url, "notifico");
    reg!(ntfy::Ntfy::from_url, "ntfy", "ntfys");
    reg!(office365::Office365::from_url, "o365");
    ...
    reg!(parseplatform::ParsePlatform::from_url, "parse");
    ...
    reg!(pushdeer::PushDeer::from_url, "pushdeer");
    ...
    reg!(pushsafer::Pushsafer::from_url, "psafer");
    ...
    reg!(streamlabs::Streamlabs::from_url, "streamlabs");
