...
pub struct WxPusher { token: String, uids: Vec<String>, verify_certificate: bool, tags: Vec<String>, #[cfg(test)] api_url_override: Option<String> }
impl WxPusher {
    pub fn from_url(url: &ParsedUrl) -> Option<Self> {
        ...
        Some(Self { token, uids, verify_certificate: url.verify_certificate(), tags: url.tags(), #[cfg(test)] api_url_override: None })
    }
...
impl Notify for WxPusher {
    ...
    async fn send(&self, ctx: &NotifyContext) -> Result<bool, NotifyError> {
        ...
        let api_url = {
            #[cfg(test)] { self.api_url_override.as_deref().unwrap_or("https://wxpusher.zjiecode.com/api/send/message") }
            #[cfg(not(test))] { "https://wxpusher.zjiecode.com/api/send/message" }
        };
